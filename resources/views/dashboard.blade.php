    ...
    {{-- Pesan Peringatan untuk Supplier Belum Terverifikasi --}}
        ...
        @role('admin')
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <h3 class="text-gray-500 text-sm font-medium">Total Pimpinan</h3>
                    <p class="text-3xl font-bold mt-2">{{ $totalPimpinan }}</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm">
                    <h3 class="text-gray-500 text-sm font-medium">Total Verifikator</h3>
                    <p class="text-3xl font-bold mt-2">{{ $totalVerifikator }}</p>
                </div>
            </div>
        ...
        @else
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 h-64 flex items-center justify-center bg-cover bg-center text-white" style="background-image: url('https://picsum.photos/1200/400?grayscale');">
            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    @forelse ($products as $product)
                        <div @click="selectedProduct = {{ json_encode($product) }}; showModal = true" class="cursor-pointer">
